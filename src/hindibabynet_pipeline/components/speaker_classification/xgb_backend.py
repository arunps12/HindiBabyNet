...
from hindibabynet_pipeline.components.speaker_classification.base import ClassificationBackend
from hindibabynet_pipeline.components.speaker_classification.metadata import (
    make_run_info,
    utcnow_iso,
    write_run_info,
)
from hindibabynet_pipeline.components.speaker_classification.output_checks import is_xgb_complete
...
class XGBBackend(ClassificationBackend):
    """
    Native HindiBabyNet backend: VAD â†’ diarization â†’ eGeMAPS â†’ XGBoost.
    ...
    def run_participant(
        ...
        from hindibabynet_pipeline.components.speaker_classification._xgb_core import (
